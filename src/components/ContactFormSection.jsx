...
const ContactFormSection = () => {
  ...
  // Form state variables - add phone fields
  const [formData, setFormData] = useState({
    name: '',
    email: '',
    countryCode: 'LK', // Default country code (Sri Lanka)
    phone: '',
    message: ''
  });
  ...
  // Load EmailJS credentials from environment variables with fallbacks for safety
  ...
  // Get country codes from the library instead of hardcoding
  ...
  const formatCountryForDisplay = (countryCode) => {
    try {
      ...
      // Fallback if there's an error getting country information
      return { 
        code: countryCode, 
        dialCode: '', 
        name: countryCode 
