...
export default function FirstView() {
  ...
  return (
    <div className="relative w-full h-screen bg-gray-900 overflow-hidden" style={pageBackgroundStyle}>
      <style jsx>{`
        @keyframes pulse {
          0% { transform: scale(${logoScale}) rotate(${logoRotation}deg); }
          50% { transform: scale(${logoScale * 1.1}) rotate(${logoRotation + 5}deg); }
          100% { transform: scale(${logoScale}) rotate(${logoRotation}deg); }
        }
      `}</style>
          ...
          {!showSecondText ? (
            <h1 className="text-white text-5xl md:text-5xl font-bold flex items-center justify-center font-poppins">
              ...
              >
                ...
                <span className="px-4 z-10 relative font-poppins" style={textFillImageStyle}>Innovation</span>
              </div>
            </h1>
          ) : (
            ...
            <h1 className="text-white text-5xl md:text-5xl font-bold flex items-center justify-center font-poppins">
              ...
              >
                <div className="absolute w-full h-full bg-white rounded z-0"></div>
                <span className="px-4 z-10 relative font-poppins" style={textFillImageStyle}>Flowiix.com</span>
              </div>
            </h1>
          )}
        </div>
