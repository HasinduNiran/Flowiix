  ...
  return (
    <div className="flex-1 w-full relative min-h-[80vh]">
      ...
      <div className="relative z-10 w-full flex flex-col md:flex-row justify-between items-center max-w-6xl mx-auto p-4 pb-[260px]">
        <div className="md:w-1/2 flex flex-col items-start mb-12 md:mb-0 md:pr-12">
          ...
          <p className="mb-8 text-gray-200 text-lg leading-relaxed max-w-md">
          ...
          <div className="flex space-x-4">
            <a href="#" className="group relative">
              ...
              <div className="relative p-3 bg-primary backdrop-blur-lg rounded-full border border-white border-opacity-10 hover:border-opacity-30 transition-all duration-300 hover:-translate-y-1">
        ...
        <div className="md:w-1/2 w-full max-w-md relative z-20">
          <div className="group relative">
            ...
            <div className="relative bg-primary backdrop-blur-lg rounded-lg p-8 border border-white border-opacity-10 hover:border-opacity-30 transition-all duration-300 hover:-translate-y-1">
              <form>
                ...
                <button
                  type="submit"
                  className="w-full bg-gradient-to-r from-blue-500 to-purple-600 hover:from-blue-600 hover:to-purple-700 text-white py-3 px-6 rounded-lg font-medium transition-all duration-300 shadow-lg hover:shadow-xl transform hover:-translate-y-1 focus:outline-none focus:ring-2 focus:ring-purple-500 focus:ring-offset-2"
                >
                  Send Message
                </button>
              </form>
